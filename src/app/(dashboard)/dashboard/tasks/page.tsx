...
export default function TasksPage() {
  return (
    <div className="text-white/30 md:border md:rounded-lg md:p-6 md:bg-gradient-to-b  from-white/[0.08] to-white/[0.03]  shadow-lg md:w-[940px] mx-auto md:mt-9 relative md:-ml-12 -mt-10 ">
