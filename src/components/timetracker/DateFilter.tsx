...
export default function DateFilter() {
  return (
    <div>
      <div className="relative z-50 bg-[#0f172a] p-4 rounded-xl border border-gray-600 w-full max-w-sm mx-auto block md:hidden mt-4">
  <div className="flex flex-col gap-4">
    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <input
        type="date"
        className="bg-gray3 text-white p-2 rounded-lg border border-gray-600 flex-1"
      />
    </div>
    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <select className="bg-gray-800 text-white p-2 rounded-lg border border-gray-600 flex-1">
    ...
    {/* Button */}
    <button className="bg-blue-600 hover:bg-blue-700 px-4 py-3 rounded-lg text-white flex items-center justify-center gap-2">
      <Image
        src="/icon.png"
        alt="Filter Icon"
        width={18}
