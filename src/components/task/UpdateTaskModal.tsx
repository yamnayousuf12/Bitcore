...
export default function UpdateTaskModal({
  ...
  return (
    <>
      ...
      {/* Desktop: modal */}
      <div
        className="hidden sm:flex fixed inset-0 z-50 items-center justify-center px-4 sm:px-6  w-600 max-w-4xl h-full sm:h-auto py-6 sm:py-12 ml-52 rounded-lg mx-auto "
        onMouseDown={handleBackdropClick}
      >
        <div
