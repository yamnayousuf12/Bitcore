    ...
    <div className="p-4 text-white">
          ...
          return (
            <button
              ...
              className={`px-4 py-2 rounded-lg focus:outline-none focus:ring-0 ${
                selected ? "border-b-2 border-white font-semibold" : "text-gray-400"
              }`}
            >
              {tab}
            </button>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold text-blue-400">{policyData[activeTab].title}</h2>
          <Edit3
        ...
        <p className="text-xs text-gray-400 mt-4 text-right">Last updated: June 15, 2025</p>
      </div>
