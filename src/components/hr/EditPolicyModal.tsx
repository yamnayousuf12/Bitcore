        ...
        <div className="relative p-6">
          ...
          <div className="rounded-xl border border-white/30 bg-white/5">
            ...
            <textarea
              ...
              className="w-full min-h-[260px] resize-y bg-transparent p-4 outline-none placeholder:text-gray-400"
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={onClose}
                className="px-3 py-2 text-sm text-blue-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/40 rounded-lg"
              >
                Cancel
              </button>
              <button
