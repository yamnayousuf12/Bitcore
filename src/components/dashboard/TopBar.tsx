...
export default function TopBar({ heading, onOpenMenu }: TopBarProps) {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="lg:hidden sticky top-0 z-40 bg-[#101B31] backdrop-blur px-4 py-3 flex items-center justify-between border border-white/30 w-screen -ml-3 -mt-10 " >
        {/* Hamburger Menu */}
        <button
          onClick={onOpenMenu}
          aria-label="Open menu"
